...
import 'package:plantr/ui/views/text_reverse/text_reverse_view.dart';
// @stacked-import
...
@StackedApp(
  routes: [
    ...
    CustomRoute(
        page: CounterView, transitionsBuilder: TransitionsBuilders.fadeIn),
    CustomRoute(page: LoginView),
    CustomRoute(
        page: TextReverseView, transitionsBuilder: TransitionsBuilders.fadeIn),
// @stacked-route
